...
# BO15
INSERT INTO tournaments (id, name, language, date, deadline, fee, venue, contact, image, misc, program, details)
VALues ("bo15", "Bergen Open 2015", "no", "2015-05-17", "2015-05-16", "300 (150 for junior)", "Scandic Hotel Bergen", "endre.vestbo@gmail.com", "images/logos/nba.png", "[{\"key\": \"Bankett\", \"value\": \"Holmin spanderer!\"}]", 	"[{\"day\": \"Lørdag\", \"events\": [{\"time\": \"0800\", \"event\": \"Dørene åpner\"}, {\"time\": \"0900\", \"event\": \"Turnering starter\"}]}]", "[{\"title\": \"Informasjon\", \"content\": \"Lorem ipsum ...\"}]");
